...
check('offline precache', () => {const serviceWorker=read('service-worker.js');[...scripts.filter(file=>file.startsWith('assets/js/')),...lessons,...worksheets,...guides].forEach(file=>assert.ok(serviceWorker.includes(`./${file}`),file));assert.match(serviceWorker,/arshavin-grade4-v23/);});
