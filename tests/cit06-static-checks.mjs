...
check('shell integration',shell.includes("id: 'CIT-06'")&&shell.includes('public-rules-fairness-reviewing-decisions.html')&&shell.includes('arshavin.citizenship.fairness.v1'));
