...
| Automated regression | PENDING exact final head | Complete manifest and `tests/ai04-static-checks.mjs` are connected in GitHub Actions; exact final-head result must pass before merge |
