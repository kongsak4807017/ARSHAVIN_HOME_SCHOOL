...
## Completion counters
- Interactive bilingual lessons: **35 / 52**
- A4 student worksheets: **70 / 104 minimum**
- Teacher guides/rubrics: **34 complete guides**
...
## 2026-07-21 — MAKER-07 Magnets, Forces and Safe Sorting-System Design
- [x] Complete bilingual lesson defining magnet, magnetic force, attraction and fair test.
- [x] Keyboard-native fictional material comparison using steel, aluminium, wood and plastic with explicit text feedback.
- [x] Explicit science boundary that magnets do not strongly attract every metal and appearance is not evidence of magnetic response.
- [x] Safe sorting-system design with controlled variables, a third “uncertain/review” category and adult-supervised stop rules.
- [x] Strong-magnet, ingestion, electronics and implanted-medical-device safeguards; screen/card activity is the default.
- [x] Guarded local-only completion under `arshavin.maker.magnets.v1` using `comparisonComplete`, `designComplete` and `quizComplete`.
...
- [x] Homepage, thirty-five-lesson shell, reset key, service-worker v36, focused MAKER-07 checks and complete regression integration implemented on the feature branch.

## Acceptance status
**ACCEPTED WITH CONDITIONS** — thirty-five lessons, seventy printable A4 sheets and thirty-four teacher guides are integrated at source level. Exact final-head CI is required before merge. Browser/device, assistive-technology, physical A4 print, GitHub Pages and offline-reload verification remain required.

## Next action
Build **CIT-07 งบประมาณชุมชน ทรัพยากรสาธารณะ และการตัดสินใจอย่างโปร่งใส / Community Budgets, Public Resources and Transparent Choices** with a fictional fixed-budget allocator, needs-versus-wants reasoning, transparent criteria, accessibility and minority-impact review, no collection of real family income or political preferences, two A4 worksheets, teacher guide/rubric, offline integration and focused static regression coverage.