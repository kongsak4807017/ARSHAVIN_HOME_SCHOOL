...
## Completion counters
- Interactive bilingual lessons: **39 / 52**
- A4 student worksheets: **78 / 104 minimum**
- Teacher guides/rubrics: **38 complete guides**
...
## 2026-07-21 — ENV-08 Floods, Droughts and Community Resilience
- [x] Complete bilingual lesson defining flood, drought, hazard, exposure, capacity and resilience.
- [x] Keyboard-native fictional risk-and-response model with corrective bilingual feedback.
- [x] RIVER workflow for official information, hazard/impact, safe options, access/privacy and updates.
- [x] Explicit model limitation: not a forecast, real evacuation plan or replacement for current official warnings.
- [x] No household address, precise location, health, income, medicine, evacuation-route or vulnerability-list collection.
- [x] Guarded local-only completion under `arshavin.environment.resilience.v1` using `riskComplete`, `planComplete` and `quizComplete`.
...
- [x] Homepage, thirty-nine-lesson shell, reset key, service-worker v40, focused ENV-08 checks and complete regression integration implemented on the feature branch.

## Acceptance status
**ACCEPTED WITH CONDITIONS** — thirty-nine lessons, seventy-eight printable A4 sheets and thirty-eight teacher guides are integrated at source level. Exact final-head CI is required before merge. Browser/device, assistive-technology, physical A4 print, GitHub Pages and offline-reload verification remain required.

## Next action
Build **MAKER-08 วงจรไฟฟ้าอย่างง่าย พลังงาน และความปลอดภัย / Simple Circuits, Energy and Electrical Safety** with a fictional battery-switch-load model, no mains electricity or exposed-cell experimentation, two A4 worksheets, teacher guide/rubric, offline integration and focused static regression coverage.