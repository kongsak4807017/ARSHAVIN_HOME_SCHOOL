...
### 2026-07-19 — HB-01 Sleep for a Ready Brain
- [x] Bilingual lesson, bedtime calculator, routine activity, formative assessment and guarded local progress
- [x] Two-page A4 worksheet and offline integration

### 2026-07-19 — AI-01 Fact, Opinion or Check?
- [x] Keyboard-operable claim sorter, STOP–TRACE–CHECK–DECIDE, fictional evidence scenario and teacher guide
- [x] Two-page A4 worksheet, local progress and offline integration

### 2026-07-19 — Shared platform
- [x] Reusable learning shell with previous/overview/next navigation and local-only evidence status
- [x] Dependency-free Node static checks and GitHub Actions workflow
- [x] Responsive, print-safe, privacy-first and offline-friendly architecture

### 2026-07-19 — ENV-01 Read the Air, Choose a Safer Action
- [x] Simulated PM2.5 reader, safer-action planner, three-question assessment and current-data separation
- [x] Two-page A4 worksheet, teacher guide and offline integration

### 2026-07-19 — MAKER-01 Levers Make Work Easier
- [x] Keyboard-operable lever simulation, class identifier, safe light-object investigation and assessment
- [x] Two-page A4 worksheet, teacher guide and offline integration

### 2026-07-19 — CIT-01 Rights, Responsibilities and Digital Kindness
- [x] CLEAR fair-rule evaluator, consent/non-forwarding scenario and STOP–SAVE–TELL–SUPPORT routine
- [x] Two-page A4 worksheet, safeguarding-focused teacher guide and offline integration
